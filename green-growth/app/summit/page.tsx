      ...
      <div className="bg-green-200 py-10">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mx-auto px-10 sm:px-20 pt-10 hidden sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-4"
            style={{
          ...
          >
            {TracksData.slice(activeSummit === "summit24" ? 0 : 5, activeSummit === "summit24" ? 5 : 10).map((item: any, idx: number) => (
