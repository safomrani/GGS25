...
function SpeakerRegistrationContent() {
  ...
  const verifyEmailWithBackend = async (email: string) => {
    ...
    try {
      const result = await verifyEmail(email, 'speaker', tenantIdParam || API_CONFIG.DEFAULT_TENANT_ID);
  ...
  const validateForm = () => {
    ...
    if (!isEmailVerified) {
      showError('The email address is not verified as a speaker');
      return false;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        email_template_id: API_CONFIG.EMAIL_TEMPLATE_IDS.SPEAKER_REGISTRATION,
        guest_list_type: formData.guestListType,
        ...
        <div className="container mx-auto px-4 relative z-10" style={{ maxWidth: '960px' }}>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8" style={{ boxShadow: '0 5px 20px rgba(0,0,0,0.1)' }}>
            <h1 className="text-2xl md:text-3xl font-bold mb-6 pb-3 border-b-2" style={{ color: colors.primaryGreen, borderColor: colors.primaryGreen }}>
              Green Growth Summit 2025 - Speaker Registration
            </h1>
            ...
            {!isVerifyingEmail && !isEmailVerified && (
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-red-800">Invalid Speaker Invitation</h3>
                    <div className="mt-2 text-sm text-red-700">
                      <p>{error || "The email in your invitation link is not recognized as a speaker invitation. Please ensure you're using the exact link sent to your email."}</p>
                      <p>If you believe this is an error, please contact us at <a href={`mailto:${CONTACT.speakerEmail}`} className="underline">{CONTACT.speakerEmail}</a></p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="md:col-span-1">
                    ...
                    <input
                      ...
                      required
                    />
                    <small className="text-gray-500">Verified email from your speaker invitation</small>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <small className="text-gray-500">Link to a professional photo of yourself</small>
                  </div>
                  <div>
                    ...
                    <>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div className="grid grid-cols-4 gap-2 text-sm">
                          ...
                          <div className="col-span-3">Speaker Ticket</div>
